...
```{r lm, echo = T} 
### Linear model
model <- lm(api00 ~ as.factor(dnum), data = apiclus2)
```
...
we obtain an ICC of 0.9018736, meaning that 90% of the variability in Academic Performance Index is explained by differences between school districts--between groups.